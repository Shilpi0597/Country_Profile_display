...
public class United extends JApplet implements ActionListener{
...
static BufferedImage bg = null;
  ...
  JButton btn3=new JButton("President");
  ImageIcon icon1 = new ImageIcon("usa1.gif"); 
  private Clip clip;
United() {
	 
    try {
      bg = ImageIO.read(new File("C:/Project_Workspace/ProjectJava/usa.jpg"));
      img=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/usaf.jpg"));
      img1=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/usab.jpg"));
      img2=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/buttonb2.jpg"));
      img3=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/pusa.jpg"));
      img4=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/back.jpg"));
      img5=ImageIO.read(new File("C:/Project_Workspace/ProjectJava/usast.png"));
   ...
   //first tab panel
	...
	@Override
      protected void paintComponent(Graphics g) {
        ...
        g.drawImage(img,700, 160, 350, 200, this);
        g.setColor(Color.WHITE);
        g.setFont(new Font("Courier New",Font.PLAIN, 80));
        g.drawString("USA",800,90);
    ...
    JPanel tabPanel1 = new JPanel(new BorderLayout()) {
		...
		@Override
         protected void paintComponent(Graphics g) {
           ...
           g.setColor(Color.WHITE);
           g.setFont(new Font("Courier New",Font.PLAIN, 80));
           g.drawString("USA",30,70);
          
           //for paragraph in geography tab
           Graphics2D g2 = (Graphics2D) g;

           g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
               RenderingHints.VALUE_ANTIALIAS_ON);
           String s="The United States of America is the world's third "
           		+ "largest country in size and nearly the third largest in terms of population. "
           		+ "Located in North America, the country is bordered on the west by the Pacific Ocean"
           		+ " and to the east by the Atlantic Ocean. Along the northern border is Canada and"
           		+ " the southern border is Mexico. ";
	...
	@Override
       protected void paintComponent(Graphics g) {
         ...
         g.drawString("Capital: Washington, DC", 50, 70);
         g.drawString("Population: 316 million", 50, 120);
         g.drawString("Area: 9.8 million sq km (3.8 million sq miles)", 50, 170);
         g.drawString("Major language: English", 50, 220);
         g.drawString("Major religion: Christianity", 50, 270);
         g.drawString("Currency: US dollar", 50, 320);
     ...
     JPanel tabPanel12 = new JPanel() {
       ...
       @Override
         ...
         String hours= String.valueOf(cal.get(Calendar.HOUR)+1);
         g.setColor(Color.WHITE);
         g.setFont(new Font("Courier New",Font.PLAIN, 80));
     ...
     JPanel tabPanel3 = new JPanel(new BorderLayout()) {
		...
		@Override
         protected void paintComponent(Graphics g) {
           ...
           g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
               RenderingHints.VALUE_ANTIALIAS_ON);
           String s="The USA is the world's foremost "
           		+ "economic and military power, with global interests"
           		+ " and an unmatched global reach.America's gross domestic product "
           		+ "accounts for close to a quarter of the world total, and its military "
           		+ "budget is reckoned to be almost as much as the rest of the world's defence"
           		+ " spending put together.The country is also a major source of entertainment:"
           		+ " American TV, Hollywood films, jazz, blues, rock and rap music are primary ingredients "
    ...
    frame.setDefaultCloseOperation(frame.DISPOSE_ON_CLOSE);
	 ...
	 if(e.getSource() == btn2)
		...
		{    boolean playing=false; 
	        ...
	        URL url = this.getClass().getClassLoader().getResource("USA.wav");
	     ...
	     JPanel p1=new JPanel()
			...
			@Override
	         protected void paintComponent(Graphics g) {
	           ...
	           g.drawString("Donald Trump", 400, 50);
	           g.drawString("President of USA", 400, 100);
	           g.setColor(Color.BLACK);
	           Graphics2D g2 = (Graphics2D) g;

	              g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
	                  RenderingHints.VALUE_ANTIALIAS_ON);
	              String s="Donald John Trump is the 45th and current "
	              		+ "President of the United States. Prior to entering"
